...
var messages = map[string]map[string]string{
	LocaleZH: {
		...
		"error.payment_amount_exceeds_limit":       "支付金额超出限额",
		...
		"error.payment_capture_failed":             "支付确认失败",
	...
	LocaleTW: {
		...
		"error.payment_amount_exceeds_limit":       "支付金額超出限額",
		...
		"error.payment_capture_failed":             "支付確認失敗",
	...
	LocaleEN: {
		...
		"error.payment_amount_exceeds_limit":       "Payment amount exceeds limit",
		...
		"error.payment_capture_failed":             "Payment capture failed",
